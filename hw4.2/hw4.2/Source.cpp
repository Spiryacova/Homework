...
int main()
{
	...
	fin.close();
	cout << "Если какие-то числа встречаются в массиве с одинаковой частотой(и это максимум),\nто программа выведет наименьшее из них" << endl;
	cout << commonInt(sortArray, length) << " встречается чаще всех в массиве" << endl;
	delete[] sortArray;
	pause();
	return 0;
}